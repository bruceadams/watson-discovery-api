...
impl QueryAggregation {
  ...
  pub fn with_type_(mut self, type_: String) -> QueryAggregation {
    self.type_ = Some(type_);
    self
  }
  ...
  pub fn with_results(mut self, results: Vec<::models::AggregationResult>) -> QueryAggregation {
    self.results = Some(results);
    self
  }
  ...
  pub fn with_matching_results(mut self, matching_results: i32) -> QueryAggregation {
    self.matching_results = Some(matching_results);
    self
  }
  ...
  pub fn with_aggregations(mut self, aggregations: Vec<::models::QueryAggregation>) -> QueryAggregation {
    self.aggregations = Some(aggregations);
    self
  }
