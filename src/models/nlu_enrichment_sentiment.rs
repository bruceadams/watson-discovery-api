...
pub struct NluEnrichmentSentiment {
...
impl NluEnrichmentSentiment {
  /// An object specifying the sentiment extraction enrichment and related parameters.
  pub fn new() -> NluEnrichmentSentiment {
  ...
  pub fn with_document(mut self, document: bool) -> NluEnrichmentSentiment {
    self.document = Some(document);
    self
  }
  ...
  pub fn with_targets(mut self, targets: Vec<String>) -> NluEnrichmentSentiment {
    self.targets = Some(targets);
    self
  }
