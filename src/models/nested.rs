...
impl Nested {
  ...
  pub fn with_type_(mut self, type_: String) -> Nested {
    self.type_ = Some(type_);
    self
  }
  ...
  pub fn with_results(mut self, results: Vec<::models::AggregationResult>) -> Nested {
    self.results = Some(results);
    self
  }
  ...
  pub fn with_matching_results(mut self, matching_results: i32) -> Nested {
    self.matching_results = Some(matching_results);
    self
  }
  ...
  pub fn with_aggregations(mut self, aggregations: Vec<::models::QueryAggregation>) -> Nested {
    self.aggregations = Some(aggregations);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> Nested {
    self.path = Some(path);
    self
  }
