...
impl TrainingExample {
  ...
  pub fn with_document_id(mut self, document_id: String) -> TrainingExample {
    self.document_id = Some(document_id);
    self
  }
  ...
  pub fn with_cross_reference(mut self, cross_reference: String) -> TrainingExample {
    self.cross_reference = Some(cross_reference);
    self
  }
  ...
  pub fn with_relevance(mut self, relevance: i32) -> TrainingExample {
    self.relevance = Some(relevance);
    self
  }
